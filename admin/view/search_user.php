...
<div id="slogan"><span class="style1">จัดการข้อมูลผู้ใช้ </span><form action="search_user.php" method="post" name="search">
...
$view = mysql_query("SELECT * FROM user where firstname like '%$search%' or lastname like '%$search%'");
...
<div id="footer">
            ออกแบบและพัฒนาระบบ: <a href="http://bls.buu.ac.th/">นายนัสมี สาและ และ นายนาซอรี ลอตง</a><br>
            </p
    ></div>
